...
)
{
    ...
    {
        return httpContextAccessor?.HttpContext?.User.FindFirst(ContextServiceCode.SessionCode)?.Value;
    }
    ...
    public string LanguageId
    {
        get
        {
            var lang = (httpContextAccessor?.HttpContext?.Request.Headers[ContextServiceCode.HeaderLanguage])
                .AsDefaultString();
            if (string.IsNullOrEmpty(lang))
            {
                return ContextServiceCode.DefaultLang;
            }
    ...
    {
        var clientId = (httpContextAccessor?.HttpContext?.Request.Headers[ContextServiceCode.SessionCode])
            .AsDefaultString();
